if not ChromosomeAnalyzerDefined then
...
ChromosomeAnalyzer = {}
	...
	function ChromosomeAnalyzer.common(chromosome, otherChromosome)
		...
		for _, innovation in pairs(commonGenesInnovations) do
			table.insert(commonGenes, moreFitChromosome:genes()[innovation])
			table.insert(lessFitCommonGenes, lessFitChromosome:genes()[innovation])
		end
	...
	function ChromosomeAnalyzer.disjointAndExcessGenes(chromosome, otherChromosome)
		...
		for _, innovation in pairs(disjointGenesInnovations) do
			if chromosome:genes()[innovation] then
				table.insert(disjointGenes, chromosome:genes()[innovation])
			else
				table.insert(disjointGenes, otherChromosome:genes()[innovation])
			end
		end

		for _, innovation in pairs(excessGenesInnovations) do
			if chromosome:genes()[innovation] then
				table.insert(excessGenes, chromosome:genes()[innovation])
			else
				table.insert(excessGenes, otherChromosome:genes()[innovation])
			end
		end -- end of filling
...
ChromosomeAnalyzerDefined = true
end